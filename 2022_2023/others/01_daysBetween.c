...
int main(int argc, char *argv[]) {
  ...
  if (argc == 7) {
    day1.giorno = atoi(argv[1]);
    day1.mese = atoi(argv[2]);
    day1.anno = atoi(argv[3]);
    day2.giorno = atoi(argv[4]);
    day2.mese = atoi(argv[5]);
    day2.anno = atoi(argv[6]);
    ...
    printf("Insert a valid number of argument");
