...
\begin{proof} derivata di $v$, integrale per sostituzione e discussione della
	monotonia
	\begin{itemize}
		\item Siccome $\underline{r}$ è regolare
		      \[
			      \text{len}(\underline{r}([a,b])) = \int_{a}^{b} ||
			      \underline{r}'(t) || dt \]
		\item allora $\forall s \in [c,d]$
		      \[
			      ...
			      \end{bmatrix}
			      = \varphi'(s) \underline{r}'(\varphi(s))\\
		      \]
		      quindi
		      \[
			      ||\underline{v}'(s)|| = ||\varphi'(s)
			      \underline{r}'(\varphi(s))|| = |\varphi'(s)| ||
			      \underline{r}'(\varphi(s))||
		      \]
		...
		\item se $\varphi$ è crescente, allora $\varphi(c) = a < b =
		      ...
		      \[
			      ...
			      \underline{r}'(\varphi(s))|| \]
		      \[
			      \text{len}(\underline{r}([a,b])) =
			      \int_{a}^{b} || \underline{r}'(t) || dt =
			      \int_{c}^{d} || \underline{r}'(\varphi(s))|| \varphi'(s) ds =
			      \int_{c}^{d} || \underline{v}'(s) || ds =
			      \text{len}(\underline{v}([c,d]))
		      \]
		\item se $\varphi$ è decrescente, allora $\varphi(c) = b > a =
		      ...
		      \[
			      \text{len}(\underline{r}([a,b])) =
			      \int_{a}^{b} || \underline{r}'(t) || dt =
			      \int_{d}^{c} || \underline{r}'(\varphi(s))|| \varphi'(s) ds =
			      \int_{c}^{d} || \underline{v}'(s) || ds =
			      \text{len}(\underline{v}([c,d]))
		      \]
	\end{itemize}
...
\begin{theorem} [Criterio della matrice Hessiana]
	...
	\end{itemize}
\end{theorem}
\begin{proof} teorema della matrice di rappresentazione, formula di Taylor e
	limite
	\begin{itemize}
		...
		\item quindi per la definizione di forma quadratica definita positiva e
		      il teromera della matrice di rappresentazione
		      \[
