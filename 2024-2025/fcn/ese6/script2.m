...
% Inperpolazione composita lineare
epsilon_ICL = interp1(sigma, epsilon, sigma_dis)

figure(3)
plot(sigma, epsilon, 'ko', sigma_dis, epsilon_IL, '--r', sigma_dis, epsilon_ICL, '--m', 'linewidth', 1.3)
...
fprintf('Sigma      : %f %f\n', sigma_v);
fprintf('Epsilon IL : %f %f\n', epsilon_IL_v); % 0.75 e' fuori dal dominio... l'interpolazione fa schifo
fprintf('epsilon ICL: %f %f\n', epsilon_ICL_v); % 0.75 e' fuori dal dominio... l'interpolazione non esiste
